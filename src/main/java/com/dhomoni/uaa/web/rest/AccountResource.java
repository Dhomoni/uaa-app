...
import com.dhomoni.uaa.web.rest.errors.EmailNotFoundException;
import com.dhomoni.uaa.web.rest.errors.InternalServerErrorException;
...
public class AccountResource {
	...
	public void saveAccount(@Valid @RequestBody UserDTO userDTO) {
		...
		if (!user.isPresent()) {
			throw new InternalServerErrorException(USER_COULD_NOT_BE_FOUND);
		}
